...
import com.example.trainingzonev4.controllers.baseControllers.listAbstractSwipeLeftRightController.utils.DrawableUtils;
import com.example.trainingzonev4.controllers.baseControllers.listAbstractSwipeLeftRightController.utils.ViewUtils;
...
public abstract class DraggableSwipeableExampleAdapter
    ...
    public static class MyViewHolder extends AbstractDraggableSwipeableItemViewHolder {
        ...
        public MyViewHolder(View v) {
            ...
            mDragHandle = v.findViewById(R.id.drag_handle_left);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        // set text
        holder.mTextView.setText(item.getText()+" "+item.getTimes());
    ...
    protected abstract int getSwipeLeftImage();
    protected abstract int getSwipeRightImage();
    ...
    public void onSetSwipeBackground(@NonNull MyViewHolder holder, int position, int type) {
        ...
        switch (type) {
            ...
            case Swipeable.DRAWABLE_SWIPE_LEFT_BACKGROUND:
                bgRes = getSwipeLeftImage();
                break;
            case Swipeable.DRAWABLE_SWIPE_RIGHT_BACKGROUND:
                bgRes = getSwipeRightImage();
                break;
        }
    ...
    private static class SwipeRightResultAction extends SwipeResultActionRemoveItem {
        ...
        protected void onPerformAction() {
            ...
            mAdapter.mProvider.addItemByPosition(mPosition);

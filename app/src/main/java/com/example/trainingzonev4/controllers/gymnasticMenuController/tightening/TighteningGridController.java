...
public class TighteningGridController extends SwapAndOpenAbstractGridController {
    ...
    protected GymnasticModel[] getGymnasticModel() {
        ...
        return new GymnasticModel[] {
                new GymnasticModel(R.string.tightening_level_1),
                new GymnasticModel(R.string.tightening_level_2),
                new GymnasticModel(R.string.tightening_level_3),
                new GymnasticModel(R.string.tightening_level_4),
                new GymnasticModel(R.string.tightening_level_5),
                new GymnasticModel(R.string.tightening_level_6),
                new GymnasticModel(R.string.tightening_level_7),
                new GymnasticModel(R.string.tightening_level_8),
                new GymnasticModel(R.string.tightening_level_9),
                new GymnasticModel(R.string.tightening_level_10),
        };
    }
    ...
    public TighteningGridController(String title, int dotColor, int fromPosition) {
    ...
    public TighteningGridController(Bundle args) {
        super(args);
    }

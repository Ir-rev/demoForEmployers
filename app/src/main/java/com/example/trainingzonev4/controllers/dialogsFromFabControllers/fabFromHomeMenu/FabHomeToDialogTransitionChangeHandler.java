package com.example.trainingzonev4.controllers.dialogsFromFabControllers.fabFromHomeMenu;
...
public class FabHomeToDialogTransitionChangeHandler extends FabAbstractToDialogTransitionChangeHandler {
    ...
    protected Transition getTransition(@NonNull final ViewGroup container, @Nullable final View from, @Nullable final View to, boolean isPush) {
        ...
        Transition fabTransform = new FabTransform(ContextCompat.getColor(container.getContext(), R.color.colorAccent), R.drawable.ic_spa_black_24dp);
